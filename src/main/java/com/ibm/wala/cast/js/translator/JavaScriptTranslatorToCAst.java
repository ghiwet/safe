...
public interface JavaScriptTranslatorToCAst extends TranslatorToCAst {
  ...
  class RootContext<C extends WalkContext<C, T>, T> extends TranslatorToCAst.RootContext<C, T> implements WalkContext<C,T> {
  ...
  class TryCatchContext<C extends WalkContext<C, T>, T> extends DelegatingContext<C,T> {
   ...
   */
  class MemberDestructuringContext<C extends WalkContext<C, T>, T> extends DelegatingContext<C,T> {
