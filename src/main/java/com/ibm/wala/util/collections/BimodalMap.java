...
public class BimodalMap<K, V> implements Map<K, V> {
  ...
  public boolean isEmpty() {
    return (backingStore == null) || backingStore.isEmpty();
  }
  ...
  public boolean containsKey(Object key) {
    return (backingStore != null) && backingStore.containsKey(key);
  }
  ...
  public boolean containsValue(Object value) {
    return (backingStore != null) && backingStore.containsValue(value);
  }
