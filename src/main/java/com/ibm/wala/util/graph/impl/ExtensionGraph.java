...
public class ExtensionGraph<T> implements NumberedGraph<T> {
  ...
  private final NumberedEdgeManager<T> edgeManager = new NumberedEdgeManager<T>() {
    ...
    public Iterator<T> getPredNodes(T n) {
      Iterator<T> orig = (original.containsNode(n)? original.getPredNodes(n): EmptyIterator.instance());
    ...
    public Iterator<T> getSuccNodes(T n) {
      Iterator<T> orig = (original.containsNode(n)? original.getSuccNodes(n): EmptyIterator.instance());
