...
public class MutableSharedBitVectorIntSet implements MutableIntSet {
  ...
  private void checkIntegrity() {
    ...
    assert sharedPart == null || !sharedPart.isEmpty();
      assert privatePart == null || sharedPart == null || privatePart.intersection(sharedPart).isEmpty();
  }
  ...
  public boolean contains(int i) {
    if (privatePart != null && privatePart.contains(i)) {
      ...
      return sharedPart != null && sharedPart.contains(i);
  }
  ...
  public boolean containsAny(IntSet set) {
    if (set instanceof MutableSharedBitVectorIntSet) {
      ...
      if (sharedPart != null) {
        ...
        return privatePart != null && privatePart.containsAny(set);
    } else {
