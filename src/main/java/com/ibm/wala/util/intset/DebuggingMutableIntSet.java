...
class DebuggingMutableIntSet implements MutableIntSet {
  ...
  @Override
  public int size() {
      assert primaryImpl.size() == secondaryImpl.size() || primaryImpl.size() == secondaryImpl.size() : "size " + primaryImpl.size() + " of " + primaryImpl
  ...
  public boolean add(int i) {
    ...
    boolean sr = secondaryImpl.add(i);
      ...
      assert pr == sr || pr == sr : "adding " + i + " to " + primaryImpl + " returns " + pr + ", but adding " + i + " to "
  ...
  public boolean containsAny(IntSet set) {
    if (set instanceof DebuggingMutableIntSet) {
      ...
      boolean ssr = secondaryImpl.containsAny(db.secondaryImpl);
        ...
        assert ppr == ssr || ppr == ssr : "containsAny " + this + " " + set + " " + ppr + " " + ssr;
      return ppr;
    } else {
      Assertions.UNREACHABLE();
      return false;
  ...
  public void intersectWith(IntSet set) {
    if (set instanceof DebuggingMutableIntSet) {
      ...
      secondaryImpl.intersectWith(db.secondaryImpl);
        ...
        assert primaryImpl.sameValue(secondaryImpl) : this + " (" + primaryImpl.size() + ", " + secondaryImpl.size()
