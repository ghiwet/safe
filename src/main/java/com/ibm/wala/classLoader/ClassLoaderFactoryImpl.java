  ...
  protected IClassLoader makeNewClassLoader(ClassLoaderReference classLoaderReference, IClassHierarchy cha, IClassLoader parent,
    ...
    if (implClass == null) {
      ...
      try {
        ...
        Constructor<?> ctor = impl.getDeclaredConstructor(ClassLoaderReference.class, IClassLoader.class,
        ...
        try {
          Class<?> impl = Class.forName(implClass);
          Constructor<?> ctor = impl.getDeclaredConstructor(ClassLoaderReference.class, ArrayClassLoader.class,
